...
using Spring Data repositories, everything in Kotlin.
...
- [Ptyhon Django](https://github.com/melardev/DjanogApiCrud)
- [Ptyhon Flask](https://github.com/melardev/FlaskApiCrud)
